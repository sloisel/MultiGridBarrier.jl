...
This page is the guided tour of the native (low-level) API: the workflow, the mesh
constructors and their coordinate/connectivity conventions, and the hierarchy builders.
For the high-level modeling front end see [JuMP](jump.md); for the docstrings see the
